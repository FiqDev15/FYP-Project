...
button.:focus {
    outline: none;
      ...
      <script type="text/javascript">
        function inactivebtn(snoempin){
         var cof=confirm("Are you sure you want to INACTIVE this Employee?");
         if(cof==true){
         	window.location='inactiveemp.php?snoempin='+snoempin;
         }
         }
         function activebtn(snoempac){
         var cof=confirm("Are you sure you want to ACTIVE this Employee?");
         if(cof==true){
         	window.location='activeemp.php?snoempac='+snoempac;
         }
         }
         </script>
   </head>
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover">
                  ...
                  <?php
                           ...
                           include("dbconn.php");
                           $counter = 1;
                           $sqlempD="SELECT *   FROM employee order by empRole asc";
                        ...
                        <tr>
                           ...
                           <td><?php echo $row_rs['empUN'];?></td>
                           <td><?php echo $row_rs['empName']; ?></td>
                           <td><?php echo $row_rs['empPwd']; ?></td>
                           <td><?php if($row_rs['empUN'] != $empUN) { ?>
                              <?php if($row_rs['statusemp'] == "active") { ?>
                                            <button onClick="inactivebtn(<?php echo $row_rs['empID']; ?>)" class="status status-active">Active
	                                        <?php }
                                           else if($row_rs['statusemp'] == "inactive") { ?>
                                            <button onClick="activebtn(<?php echo $row_rs['empID']; ?>)" class="status status-inactive">Inactive
	                                        <?php }   ?>   
                                           <?php }   ?>                                
                                          </td>   
                        </tr>
