...
<html lang="en" >
   ...
   <meta charset="UTF-8">
      ...
      <title>SUNNY DENTAL Payment</title>
...
table .status-paid {
  ...
  color: #388e3c;
      ...
      <script>
         ...
         if(cof==true){
         	window.location='payui.php?snop='+snop;
         }
         }
         function print(sno2){
         var cof=confirm("Are you sure you want to PRINT this payment?");
         if(cof==true){
         	window.location='billing.php?sno2='+sno2;
         }
         }
      </script>
   </head>
                     ...
                     <table class="table table-bordered table-hover">
                                    <thead>
                                       <tr bgcolor="#443ea2">
                                          ...
                                          <th><font color="white">PAYMENT ID </font></th>
                                          <th><font color="white">PATIENT IC</font></th>
                                          <th><font color="white">PATIENT NAME </font></th>
                                          <th><font color="white">TOTAL ISSUED</font></th>
                                          <th><font color="white">PAYMENT TOTAL</font></th>
                                          <th><font color="white">STATUS</font></th>
                                          <th><font color="white">ACTION</font></th>
                                          <th><font color="white">PRINT RECEIPT</font></th>
                                       </tr>
                                    </thead>
                                    <?php
                                       // database connection 
                                       include("dbconn.php");
                                       $counter = 1;
                                       $sqlpat="SELECT * FROM patient pat INNER JOIN appointment AS a ON a.patientIC = pat.patientIC INNER JOIN treatment t ON t.treatmentID = a.treatmentID INNER JOIN employee e on e.empID = a.empID INNER JOIN payment p ON p.appID = a.appID ORDER BY `paymentID` ASC;";
                                       $rs = mysqli_query($dbconn, $sqlpat);
                                    ...
                                    <tbody>
                                       <tr >
                                          ...
                                          <td><?php echo $row_rs['paymentID']; ?></td>
                                          <td><?php echo $row_rs['patientIC']; ?></td>
                                          <td><?php echo $row_rs['patientName']; ?></td>
                                          <td><?php echo $row_rs['total_issued']; ?></td>
                                          <td><?php echo $row_rs['paymentTotal']; ?></td>
                                          <td><?php if($row_rs['paymentTotal'] != '0') { ?>
                                          ...
                                          <td align="center">                                                                                                              
                                             <input type="button" value="pay" onClick="pay(<?php echo $row_rs['paymentID']; ?>)">                                           
                                          </td>
                                          <td><?php if($row_rs['paymentTotal'] != '0') { ?>
	                                       <input type="button" value="print" onClick="print(<?php echo $row_rs['paymentID']; ?>)">
	                                        <?php }?>                                       
                                          </td>
