...
<html lang="en" >
   ...
   <meta charset="UTF-8">
      ...
      <title>SUNNY DENTAL Treatment</title>
...
button{background-color:#443ea2;
  font-weight: bold;
left: 30px;
float: right;}
      </style>
      ...
      <script type="text/javascript">
         function deltreat(snodtreat){
         var cof=confirm("Are you sure you want to DELETE this treatment?");
         if(cof==true){
         	window.location='deltreat.php?snodtreat='+snodtreat;
         }
         }
         function updtreat(snoutreat){
         var cof=confirm("Are you sure you want to UPDATE?");
         if(cof==true){
         	window.location='treatmentupdate.php?snoutreat='+snoutreat;
         }
         }
      </script>
   </head>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <form action="addtreat.php">
    <button type="submit" ><font color="white">ADD NEW TREATMENT</font></button>
</form>
              </div>
              <!-- ./card-header -->
              <div class="card-body">
                <table class="table table-bordered table-hover">
                  <thead>                    
                    <tr bgcolor="#443ea2">                      
                      <th><font color="white">Treatment ID</font></th>
                      <th><font color="white">Treatment Name</font></th>
                      <th><font color="white">Treatment Cost</font></th>                      
                    </tr>                 
                  </thead>
                  <?php
                              // database connection 
                              include("dbconn.php");
                              $counter = 1;
                              $sql="SELECT * FROM treatment WHERE treatmentID != 0";
                  ...
                  <tbody>
                    <tr data-widget="expandable-table" aria-expanded="false">                      
                      <td><?php echo $row_rs['treatmentID']; ?></td>
                      <td><?php echo $row_rs['treatmentName']; ?></td>
                      <td><?php echo $row_rs['treatmentCost']; ?></td>                      
                    </tr>
                    <tr class="expandable-body d-none">
                      <td align="center" colspan="5">
                       <p style="display: none;">
                        <!--/<input type="button" value="deltreat" onClick="deltreat(<?php echo $row_rs['treatmentID']; ?>)"> -->               
                        <input type="button" value="Update" onClick="updtreat(<?php echo $row_rs['treatmentID']; ?>)">
                        </p>
                      </td>
                    </tr>
                 </tbody>
