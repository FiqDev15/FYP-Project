...
<html lang="en" >
   ...
   <meta charset="UTF-8">
      ...
      <script>
         ...
         if(cof==true){
         	window.location='updatepatient.php?sno1='+sno1;
         }
         }
      </script>
        <script type="text/javascript">
         function del(sno){
         var cof=confirm("Are you sure you want to DELETE?");
         if(cof==true){
         	window.location='delpatient.php?sno='+sno;
         }
         }
      </script>
   </head>
                                 ...
                                 <table class="table table-bordered table-hover">
                                    <thead>
                                       <tr bgcolor="#443ea2">
                                          ...
                                          <th><font color="white">PATIENT AGE </font></th>
                                          <th><font color="white">PATIENT GENDER</font></th>
                                    ...
                                    <tbody>
                                       <tr >
                                          ...
                                          <td><?php echo $row_rs['patientAge']; ?></td>
                                          <td><?php echo $row_rs['patientGender']; ?></td>
                                          <td><?php echo $row_rs['patientPhoneNumber']; ?></td>
                                          <td><?php echo $row_rs['patientAddress']; ?></td>
                                          <td align="center">                                             
                                             <input type="button" value="upd" onClick="upd(<?php echo $row_rs['patientIC']; ?>)">
                                          </td>
                                       </tr>
                                    </tbody>
                                    <?php } ?>
