            ...
            <div class='dashboard-content'>
               <div class='container'>
                  <div class='card'>
                     ...
                     <h1><b>ADD NEW PATIENT</b></h1>
                     </div>
                     <div class='card-body'>

                        <div class="card card-primary">

<form id="formnewapp" name="formnewapp" method="post" action="addpatient.php">
<div class="card-body">
<div class="form-group">
<label for="patientIC">PATIENT IC</label>
<input type="text" class="form-control" id="patientIC" name="patientIC" placeholder="Enter patient IC" required>
</div>
<div class="form-group">
...
<input type="text" class="form-control" id="patientAge" name="patientAge" placeholder="Enter patient age" required>
</div>
<div class="form-group">
                              <label for="patientGender">PATIENT GENDER</label>
                              <select class="custom-select form-control-border border-width-2" id="exampleSelectBorderWidth2" name="patientGender" id="patientGender">
                                 <option value="time">Select Gender</option>
...
<input type="text" class="form-control" id="patientPhoneNumber" name="patientPhoneNumber" placeholder="Enter patient phone number" required>
</div>
<div class="form-group">
<label for="patientAddress">PATIENT ADDRESS</label>
<input type="text" class="form-control" id="patientAddress" name="patientAddress" placeholder="Enter patient address " required>
</div>



                           <div class="card-footer">
                              <button  type"button" class="btn btn-primary" name="SIMPAN" value="Simpan" onClick="return checkEmptyFields()">Add New Patient</button>
                           </div>
                     </form>
</div>
                     </div>
