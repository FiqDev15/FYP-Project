            ...
            <div class='card'>
               ...
               <div class='card-body'>
                  ...
                  <div class="card card-primary">                    
                     ...
                     <form id="formnewapp" name="formnewapp" method="post" action="addnewapp.php">
                        <div class="card-body">
                 
                           <div class="form-group">
                              <label for="appDate">APPOINTMENT DATE</label>
                              <input type="date" class="form-control" id="appDate" name="appDate" placeholder="Enter appointment date">
                           </div>
                           <div class="form-group">
                              <label for="appointmentTime">APPOINTMENT TIME</label><br>                                                                   
                              <select class="custom-select form-control-border border-width-2" id="exampleSelectBorderWidth2" name="appointmentTime" id="appointmentTime">
                           ...
                           <div class="form-group">
                              ...
                              <?php
                                 include("dbconn.php");
                                 echo "<tr>";			
                                 echo "<td><select class='custom-select form-control-border border-width-2' id='exampleSelectBorderWidth2' name='patientIC'>";
                                 echo "<option value='chooseP'>Choose Patient</option>";
                                 ...
                                 while($rpatient= mysqli_fetch_assoc($querypatient))
                                 {
                                 	...
                                 	if($r['patientIC'] == $rpatient['patientIC'])
                                 	{
                                 		echo "<option value='".$rpatient['patientIC']."' selected>";
                                 		echo $rpatient['patientIC']."-".$rpatient['patientName'];
                                 		echo "</option>";
                                 	}
                                 	else
                                 	{
                                 		echo "<option value='".$rpatient['patientIC']."'>";
                                 		echo $rpatient['patientIC']."-".$rpatient['patientName'];
                                 		echo "</option>";
                                 	}
                                 }
                           ...
                           <div class="form-group">
                              <label for="empid">DOCTOR NAME</label>
                              <?php
                                 include("dbconn.php");
                                 				 echo "<tr>";
                                 			
                                 			echo "<td><select class='custom-select form-control-border border-width-2' id='exampleSelectBorderWidth2' name='empID'>";
                                 			echo "<option value='chooseD'>Choose Doctor</option>";
                                 			$sqldoctor = "SELECT * FROM employee where statusemp = 'active' and empRole = 'doctor'";
                                 			$querydoctor = mysqli_query($dbconn, $sqldoctor);
                                 			$rowdoctor = mysqli_num_rows($querydoctor);
                                 			if($rowdoctor > 0)
                                 			{
                                 				while($rdoctor= mysqli_fetch_assoc($querydoctor))
                                             
                                 				{
                                 					
                                 					if($rdoctor['empID'] == $rdoctor['empID'])
                                 					{
                                 						echo "<option value='".$rdoctor['empID']."' selected>";
                                 						echo $rdoctor['empID']."-".$rdoctor['empName'];
                                 						echo "</option>";
                                 					}
                           ...
                           <div class="card-footer">
                              <button  type"button" class="btn btn-primary" name="addnewapp" value="addnewapp" onClick="return checkEmptyFields()">Add New Appointment</button>
                           </div>
                     </form>
                     </div>
                  </div>
