...
<form id="msform" action="updpay.php" method="post">
  ...
  <fieldset>
    ...
    <h3 class="fs-subtitle">Total fee for this patient is:</h3>
    <h2 class="fs-subtitle"><?php echo $r['total_issued']?></h2>
    <!--<input type="button" class=" payment-view" value="" readonly/>-->
