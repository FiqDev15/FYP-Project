...
$sqltotalpay="SELECT SUM(total_issued) AS issued_sum FROM payment where paymentTotal != 0";
            ...
            <div class='dashboard-content'>
               <div class='container'>
                  <div class='card'>
                     ...
                     <div class='card-body'>
                        <center>DEVELEPORS: <a href="Groupinfo/groupinfo.html">Click here to see developer details</a></B></center>
                        <br><br>
                        <center>YOUR ACCOUNT TYPE IS: <B><?php echo $_SESSION['empRole'];?></B></center>
