...
<body translate="no" >
  ...
  <h2><i><font color="03e9f4">ADD NEW TREATMENT</font></i></h2>
  <form action="treataddsql.php" method="POST">

    <div class="user-box">
      <input type="text" name="treatmentCost" required="">
...
&nbsp
<form action="treatment.php"><button >
      <span></span>
