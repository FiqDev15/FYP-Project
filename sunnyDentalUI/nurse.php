...
<html lang="en" >
   ...
   <meta charset="UTF-8">
      ...
      <title>SUNNY DENTAL Nurse</title>
      ...
      <div class="dashboard-nav">
         ...
         <div class='dashboard-app'>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <CENTER><B><h3 class="card-title"><b>NURSE LIST</B></h3></B></CENTER>
                ...
                <table class="table table-bordered table-hover">
                  ...
                  <?php
                        ...
                        <tr>
                           ...
                           <td> <input type="button" value="updN" onClick="updN(<?php echo $row_rs['empID']; ?>)">                           
                        </tr>
                        <?php }
                           }
                      ?>
