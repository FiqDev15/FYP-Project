...
table .status-cancel {
   background-color: #ff2929;
    color: #7c0000;
      ...
      <script>
         ...
         function completeapp(snocom){
         var cof=confirm("COMPLETE this appointment??");
         if(cof==true){
         	window.location='completeapp.php?snocom='+snocom;
         }
         }
         function updapp(snoupdapp){
         var cof=confirm("COMPLETE this appointment??");
         if(cof==true){
         	window.location='edittreatmentdoc.php?snoupdapp='+snoupdapp;
         }
         }
      </script>
   </head>
   <body translate="no" >
      <div class='dashboard'>
         <div class="dashboard-nav"><a class="logo" target="_blank">
		<img src="https://i.ibb.co/gVjvdcN/Screenshot-2022-06-12-153524-removebg-preview.png" alt="">
            ...
            <nav class="dashboard-nav-list">
               ...
               <a
                  href="viewapp_doctor.php" class="dashboard-nav-item"><i class="fas fa-file-upload"></i> View Appointment </a>
               ...
               <div class='container'>
                  <div class='card'>
                     <div class='card-header'>
                        <h1>Welcome <?php echo $_SESSION['empName']; ?></h1>
                     </div>
                     <div class='card-body'>
                  ...
                  <?php
                           ...
                           {
                            $empID=$row_rs['empID'];
                           if($empID==substr($_SESSION['empUN'],1))
                           {?>
                        <tr>                           
                           ...
                           <td><?php if($row_rs['statusapp'] == "pending") { ?>
                              ...
                              <input type="button" value="complete" onClick="completeapp(<?php echo $row_rs['appID']; ?>)">                                                                    
	                                        <?php }
                                           else if ($row_rs['statusapp'] == "completed"){?>
